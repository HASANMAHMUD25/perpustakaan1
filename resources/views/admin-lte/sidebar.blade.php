<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/dashboard" class="brand-link">
      <img src="/adminlte/dist/img/1.png"  class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <!-- Use user's actual image if available -->
                <img src="{{ auth()->user()->profile_image_url ?? '/adminlte/dist/2.png' }}" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
                <!-- Display user name and optionally email -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
          <a href="/activity" class="nav-link @yield('active-activity')">
