        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button wire:click="cancelEdit" type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-footer justify-content-between">
                    <button wire:click="cancelEdit" type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
